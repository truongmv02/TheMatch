...
public static class BoxCastUtility
{
    ...
    public static RaycastHit2D[] BoxCastAndDraw(
        ...
        float distance = Mathf.Infinity, int layerMask = Physics2D.AllLayers,
    ...
    {
        var shifterBox = new Vector2[4];
        for (int i = 0; i < 4; i++)
        {
            shifterBox[i] = box[i] + distance;
        }
        return shifterBox;
    }
